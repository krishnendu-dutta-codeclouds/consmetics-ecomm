...
const ProductsPage = () => {
  ...
  // Always start price range from 0
  const lowestProductPrice = MIN_PRICE;
  ...
  useEffect(() => {
    if (priceRange[0] < lowestProductPrice) {
      setPriceRange([lowestProductPrice, priceRange[1]]);
    }
        ...
        <FilterSection>
          ...
          <CustomRangeSlider>
            <SliderTrack>
              <SliderRange
                style={{
                  left: `${((priceRange[0] - lowestProductPrice) / (MAX_PRICE - lowestProductPrice)) * 100}%`,
                  width: `${((priceRange[1] - priceRange[0]) / (MAX_PRICE - lowestProductPrice)) * 100}%`
                }}
              />
              <RangeInput
                type="range"
